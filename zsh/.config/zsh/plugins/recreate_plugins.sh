...
# git -C ohmyzsh remote prune origin && git -C ohmyzsh repack && git -C ohmyzsh prune-packed \
# && git -C ohmyzsh reflog expire --expire=1.day.ago && git -C ohmyzsh gc --aggressive
