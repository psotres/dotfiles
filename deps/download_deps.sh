...
if lsb_release -c | grep -q 'jammy'; then
  ...
  wget -q http://ftp.es.debian.org/debian/pool/main/t/tmux/tmux_3.5a-2~bpo12+1_amd64.deb -O tmux_3.5a-2~bpo12+1_amd64.deb
  sudo apt install -y ./tmux_3.5a-2~bpo12+1_amd64.deb
